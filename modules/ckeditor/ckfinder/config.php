...
*/
$baseUrl = '/opt/bitnami/apps/drupal/htdocs/sites/all/modules/ckeditor/ckfinder/userfiles/';
$baseDir = resolveUrl($baseUrl);
require_once '/opt/bitnami/apps/drupal/htdocs/sites/all/modules/ckeditor/includes/filemanager.config.php';
/*
...
ATTENTION: The trailing slash is required.
*/
$baseDir = '/opt/bitnami/apps/drupal/htdocs/sites/default/files/images';
/*
 * ### Advanced Settings
 */
